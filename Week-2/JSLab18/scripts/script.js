...
runFunctions(function(){console.log("Run me!");});
...
a = "This is inside my belly!!";
function myFunction(x,y){
    console.log("This is inside myFunction")
    x(y);
    }

myFunction(function(y){console.log(y);} , a );
...
*/
let myPlayer = new Player("Miguel", "Instant knowledge about any topic but only 10% of that subject and probablly 80% correct");
